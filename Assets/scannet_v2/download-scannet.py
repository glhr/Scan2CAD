...
def main():
    ...
    parser.add_argument('-o', '--out_dir', default=".", help='directory in which to download')
    ...
    parser.add_argument('--type', default='_vh_clean_2.ply', help='specific file type to download (.aggregation.json, .sens, .txt, _vh_clean.ply, _vh_clean_2.0.010000.segs.json, _vh_clean_2.ply, _vh_clean.segs.json, _vh_clean.aggregation.json, _vh_clean_2.labels.ply, _2d-instance.zip, _2d-instance-filt.zip, _2d-label.zip, _2d-label-filt.zip)')
